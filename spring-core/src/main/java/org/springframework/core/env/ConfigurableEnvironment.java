 ...
 * superinterface.                               //提供设置激活/默认的 profile  、操作底层属性的source 、
 *
 ...
 * <em>before</em> the context's {@link                                    //hyh:   PropertySource 的操作必须在refresh 之前执行
...
//提供设置激活/默认的 profile  、获取property source 、
public interface ConfigurableEnvironment extends Environment, ConfigurablePropertyResolver {
	 ...
	 */
	// 将父环境中的激活配置文件/默认配置文件/属性文件 添加到  子环境中。
	                 // 调用了此方法后， 父环境的改变 不会影响到子环境中。
