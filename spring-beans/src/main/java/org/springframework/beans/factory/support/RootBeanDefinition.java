 ...
 * typically registered as {@link GenericBeanDefinition GenericBeanDefinitions}.      // rootBeanDefintion  一般被GenericBeanDefinitions定义
 * A root bean definition is essentially the 'unified' bean definition view at runtime.
 *
 * <p>Root bean definitions may also be used for registering individual bean definitions
 * in the configuration phase. However, since Spring 2.5, the preferred way to register
 * bean definitions programmatically is the {@link GenericBeanDefinition} class.         //GeneriBeanDefinition 方式来注册bean
...
@SuppressWarnings("serial")
 //  合并后的  beanDefinition,   上下文运行时返回的对象
public class RootBeanDefinition extends AbstractBeanDefinition {
	 ...
	 */
	// 创建单例对象 对应的beanDefinition , 当 创建单例对象时 直接调用 supplier  实现类
